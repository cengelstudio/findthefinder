        ...
        <div className={styles.footerContent}>
          <div className={styles.footerTop}>
            ...
            <div className={styles.footerLinks}>
              <h4>{t('support')}</h4>
              <ul>
                <li><a href={`/${lang}_legalNotice.pdf`} target="_blank" rel="noreferrer">{t('legacy')}</a></li>
                <li><a href="/aydinlatma.pdf" target="_blank" rel="noreferrer">K.V.K.K.</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className={styles.footerBottom}>
            ...
            <div className={styles.footerLegal}>
              <a href={`/${lang}_legalNotice.pdf`} target="_blank" rel="noreferrer">
                {t('legacy')}
              </a>
